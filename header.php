  ...
  <body>
    <section class="top">
      <ul>
        ...
        <li>
          ...
          <a href="http://localhost/cart/" class="added_to_cart2 wc-forward" title="View cart">Jūsų krepšelis<i class="fa fa-cart-arrow-down"></i></a>
        </li>
        <li id="sub">
    ...
    <section class="header2">
      ...
      <div class="fb-container">
          <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fyourshop.eshop&tabs=timeline&width=200&height=200&small_header=false&adapt_container_width=false&hide_cover=false&show_facepile=true&appId" width="200" height="200" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
      </div>
    </section>
